...
const Dashboard = () => {
    ...
    const candidates = [
  {
    ...
    feedback: [
      { company: "TechCorp", rating: 4, notes: "Good communication skills." },
      { company: "InnoSoft", rating: 5, notes: "Strong technical knowledge." },
    ],
  },
  {
    name: "Bob Smith",
    ...
    feedback: [
      { company: "DevSolutions", rating: 5, notes: "Excellent backend skills." },
      { company: "CodeFactory", rating: 4, notes: "Quick problem-solving." },
    ],
  },
  {
    name: "Charlie Lee",
    ...
    feedback: [
      { company: "DesignHub", rating: 4, notes: "Creative ideas." },
      { company: "CreativeWorks", rating: 3, notes: "Needs improvement in prototyping." },
    ],
  },
];
        ...
        >
            <div className="p-10 glass">
                ...
                <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-6">
                        {candidates[selectedCandidate].feedback.map((f, i) => (
                            <FeedbackCard
                                key={i}
                                company={f.company}
                                rating={f.rating}
